    ...
    Eigen::Vector3d nv_t)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        point_to_projection_onto_plane_tait_bryan_wc(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        point_to_projection_onto_plane_tait_bryan_cw(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
...
Eigen::Matrix<double, 3, 1> get_delta_point_to_projection_onto_plane_rodrigues(
    RegistrationPlaneFeature::PoseConvention pose_convention,
    Eigen::Affine3d m_pose_wc,
    Eigen::Vector3d p_s,
    Eigen::Vector3d p_t,
    Eigen::Vector3d nv_t)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        point_to_projection_onto_plane_rodrigues_wc(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        point_to_projection_onto_plane_rodrigues_cw(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
...
Eigen::Matrix<double, 3, 1> get_delta_point_to_projection_onto_plane_quaternion(
    RegistrationPlaneFeature::PoseConvention pose_convention,
    Eigen::Affine3d m_pose_wc,
    Eigen::Vector3d p_s,
    Eigen::Vector3d p_t,
    Eigen::Vector3d nv_t)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        point_to_projection_onto_plane_quaternion_wc(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        point_to_projection_onto_plane_quaternion_cw(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
...
Eigen::Matrix<double, 3, 6> get_point_to_projection_onto_plane_jacobian_tait_bryan(
    RegistrationPlaneFeature::PoseConvention pose_convention,
    Eigen::Affine3d m_pose_wc,
    Eigen::Vector3d p_s,
    Eigen::Vector3d p_t,
    Eigen::Vector3d nv_t)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        point_to_projection_onto_plane_tait_bryan_wc_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        point_to_projection_onto_plane_tait_bryan_cw_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
...
Eigen::Matrix<double, 3, 6> get_point_to_projection_onto_plane_jacobian_rodrigues(
    RegistrationPlaneFeature::PoseConvention pose_convention,
    Eigen::Affine3d m_pose_wc,
    Eigen::Vector3d p_s,
    Eigen::Vector3d p_t,
    Eigen::Vector3d nv_t)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        point_to_projection_onto_plane_rodrigues_wc_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        point_to_projection_onto_plane_rodrigues_cw_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
...
Eigen::Matrix<double, 3, 7> get_point_to_projection_onto_plane_jacobian_quaternion(
    RegistrationPlaneFeature::PoseConvention pose_convention,
    Eigen::Affine3d m_pose_wc,
    Eigen::Vector3d p_s,
    Eigen::Vector3d p_t,
    Eigen::Vector3d nv_t)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        point_to_projection_onto_plane_quaternion_wc_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        point_to_projection_onto_plane_quaternion_cw_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
...
bool RegistrationPlaneFeature::optimize_point_to_projection_onto_plane_source_to_target(PointClouds& point_clouds_container)
{
    ...
    std::cout << "===========================================================" << std::endl;
    std::cout << "optimize_point_to_projection_onto_plane_source_to_target" << std::endl;
    ...
    compute_covariance_matrices_tait_bryan_point_to_projection_onto_plane_source_to_target(point_clouds_container, pose_convention);
    }
    if (rotation_matrix_parametrization == RotationMatrixParametrization::rodrigues) {
        covariance_matrices_before6x6 =
    compute_covariance_matrices_rodrigues_point_to_projection_onto_plane_source_to_target(point_clouds_container, pose_convention);
    }
    if (rotation_matrix_parametrization == RotationMatrixParametrization::quaternion) {
        covariance_matrices_before7x7 =
    compute_covariance_matrices_quaternion_point_to_projection_onto_plane_source_to_target(point_clouds_container, pose_convention);
    }*/

    //----------------------------------------------------------------------------------------------------
    optimize_point_to_projection_onto_plane_source_to_target(
        point_clouds_container, pose_convention, optimization_algorithm, rotation_matrix_parametrization);
    //----------------------------------------------------------------------------------------------------
...
void alpha_point_to_projection_job(
    ...
    for (size_t ii = job->index_begin_inclusive; ii < job->index_end_exclusive; ii++)
    {
        ...
        for (size_t ni = 0; ni < (*all_nns).size(); ni++)
        {
            for (size_t nj = 0; nj < (*all_nns)[ni].size(); nj++)
            {
                ...
                Eigen::Vector3d nv_t(
                    (*point_clouds)[(*j_indexes)[ni]].m_pose.rotation() *
                    (*point_clouds)[(*j_indexes)[ni]].normal_vectors_local[(*all_nns)[ni][nj].second]);
                if (nv_t.norm() != 1.0)
                {
                    continue;
                }
                ...
                {
                    delta = get_delta_point_to_projection_onto_plane_tait_bryan(pose_convention, m_pose_s_wc, p_s, p_t, nv_t);
                }
                if (rotation_matrix_parametrization == RegistrationPlaneFeature::RotationMatrixParametrization::rodrigues)
                {
                    delta = get_delta_point_to_projection_onto_plane_rodrigues(pose_convention, m_pose_s_wc, p_s, p_t, nv_t);
                }
                if (rotation_matrix_parametrization == RegistrationPlaneFeature::RotationMatrixParametrization::quaternion)
                {
                    delta = get_delta_point_to_projection_onto_plane_quaternion(pose_convention, m_pose_s_wc, p_s, p_t, nv_t);
                }
...
bool RegistrationPlaneFeature::optimize_point_to_projection_onto_plane_source_to_target(
            ...
            for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
            {
                if (i != j)
                {
                    ...
                    for (size_t k = 0; k < nns.size(); k++)
                    {
                        ...
                        Eigen::Vector3d nv_t(
                            point_clouds_container.point_clouds[j].m_pose.rotation() *
                            point_clouds_container.point_clouds[j].normal_vectors_local[nns[k].second]);
                        if (nv_t.norm() != 1.0)
                        {
                            continue;
                        }
                        ...
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::tait_bryan_xyz)
                        {
                            delta = get_delta_point_to_projection_onto_plane_tait_bryan(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::rodrigues)
                        {
                            delta = get_delta_point_to_projection_onto_plane_rodrigues(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::quaternion)
                        {
                            delta = get_delta_point_to_projection_onto_plane_quaternion(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                        }
                        ...
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::tait_bryan_xyz)
                        {
                            jacobian3x6 = get_point_to_projection_onto_plane_jacobian_tait_bryan(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::rodrigues)
                        {
                            jacobian3x6 = get_point_to_projection_onto_plane_jacobian_rodrigues(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::quaternion)
                        {
                            jacobian3x7 = get_point_to_projection_onto_plane_jacobian_quaternion(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                        }
...
//-
bool RegistrationPlaneFeature::optimize_point_to_projection_onto_plane_source_to_target_lie_algebra_left_jacobian(
    PointClouds& point_clouds_container)
{
    int number_of_unknowns_per_pose = 6;
    ...
    PoseConvention pose_convention = PoseConvention::wc;

    RotationMatrixParametrization rotation_matrix_parametrization = RotationMatrixParametrization::rodrigues;
        ...
        for (int i = 0; i < point_clouds_container.point_clouds.size(); i++)
        {
            ...
            for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
            {
                if (i != j)
                {
                    ...
                    {
                        Eigen::Vector3d p_s(point_clouds_container.point_clouds[i].points_local[nns[k].first]);
                        Eigen::Vector3d p_sg(point_clouds_container.point_clouds[i].points_local[nns[k].first]);
                        Eigen::Vector3d p_tg(
                            point_clouds_container.point_clouds[j].m_pose *
                            point_clouds_container.point_clouds[j].points_local[nns[k].second]);
                        Eigen::Vector3d nv_t(
                        ...
                        double d = -nv_t.dot(p_tg);
                        Eigen::Vector3d p_proj = p_sg - (p_sg.x() * nv_t.x() + p_sg.y() * nv_t.y() + p_sg.z() * nv_t.z() + d) * nv_t;
                        ...
                        //         factor_ballanced_horizontal_vs_vertical = 1.0 /
                        //         float(point_clouds_container.point_clouds[i].number_points_horizontal);//
                        //     }
                        //     else {
                        //         factor_ballanced_horizontal_vs_vertical = 1.0 /
                        //         float(point_clouds_container.point_clouds[i].number_points_vertical);//
                        //     }
                        // }

                        Eigen::Vector3d target = p_tg;
...
bool RegistrationPlaneFeature::optimize_point_to_projection_onto_plane_source_to_target_lie_algebra_right_jacobian(
    PointClouds& point_clouds_container)
{
    int number_of_unknowns_per_pose = 6;
    ...
    std::cout << "optimize_point_to_projection_onto_plane_source_to_target_lie_algebra_right_jacobian DONE" << std::endl;
    return true;
}

//-
std::vector<Eigen::Matrix<double, 6, 6, Eigen::RowMajor>> RegistrationPlaneFeature::
    compute_covariance_matrices_tait_bryan_point_to_projection_onto_plane_source_to_target(
        ...
        for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
        {
            if (i != j)
            {
                ...
                for (size_t k = 0; k < nns.size(); k++)
                {
                    ...
                    Eigen::Matrix<double, 3, 1> delta = get_delta_point_to_projection_onto_plane_tait_bryan(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                    ...
                    Eigen::Matrix<double, 3, 6> jacobian = get_point_to_projection_onto_plane_jacobian_tait_bryan(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
...
std::vector<Eigen::Matrix<double, 6, 6, Eigen::RowMajor>> RegistrationPlaneFeature::
    compute_covariance_matrices_rodrigues_point_to_projection_onto_plane_source_to_target(
        PointClouds& point_clouds_container, PoseConvention pose_convention)
{
    for (auto& pc : point_clouds_container.point_clouds)
    {
        ...
        for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
        {
            if (i != j)
            {
                ...
                for (size_t k = 0; k < nns.size(); k++)
                {
                    ...
                    Eigen::Matrix<double, 3, 1> delta = get_delta_point_to_projection_onto_plane_rodrigues(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                    ...
                    Eigen::Matrix<double, 3, 6> jacobian = get_point_to_projection_onto_plane_jacobian_rodrigues(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
...
std::vector<Eigen::Matrix<double, 7, 7, Eigen::RowMajor>> RegistrationPlaneFeature::
    compute_covariance_matrices_quaternion_point_to_projection_onto_plane_source_to_target(
        PointClouds& point_clouds_container, PoseConvention pose_convention)
{
    for (auto& pc : point_clouds_container.point_clouds)
    {
        ...
        for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
        {
            if (i != j)
            {
                ...
                for (size_t k = 0; k < nns.size(); k++)
                {
                    ...
                    Eigen::Matrix<double, 3, 1> delta = get_delta_point_to_projection_onto_plane_quaternion(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
                    ...
                    Eigen::Matrix<double, 3, 7> jacobian = get_point_to_projection_onto_plane_jacobian_quaternion(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, p_s, p_t, nv_t);
