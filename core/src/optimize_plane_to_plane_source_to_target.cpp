...
Eigen::Matrix<double, 4, 1> get_plane_to_plane_source_to_target_tait_bryan(
    ...
    RegistrationPlaneFeature::Plane pl_source_local,
    RegistrationPlaneFeature::Plane pl_target_global)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        plane_to_plane_source_to_target_tait_bryan_wc(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        plane_to_plane_source_to_target_tait_bryan_cw(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    RegistrationPlaneFeature::Plane pl_target_global)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        plane_to_plane_source_to_target_tait_bryan_wc_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        plane_to_plane_source_to_target_tait_bryan_cw_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    RegistrationPlaneFeature::Plane pl_target_global)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        plane_to_plane_source_to_target_rodrigues_wc(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        plane_to_plane_source_to_target_rodrigues_cw(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    RegistrationPlaneFeature::Plane pl_target_global)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        plane_to_plane_source_to_target_rodrigues_wc_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        plane_to_plane_source_to_target_rodrigues_cw_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    RegistrationPlaneFeature::Plane pl_target_global)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        plane_to_plane_source_to_target_quaternion_wc(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        plane_to_plane_source_to_target_quaternion_cw(
            delta,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    RegistrationPlaneFeature::Plane pl_target_global)
{
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::wc)
    {
        plane_to_plane_source_to_target_quaternion_wc_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
    ...
    if (pose_convention == RegistrationPlaneFeature::PoseConvention::cw)
    {
        plane_to_plane_source_to_target_quaternion_cw_jacobian(
            jacobian,
            pose_s.px,
            pose_s.py,
            pose_s.pz,
...
bool RegistrationPlaneFeature::optimize_plane_to_plane_source_to_target(PointClouds& point_clouds_container)
{
    ...
    if (rotation_matrix_parametrization == RotationMatrixParametrization::tait_bryan_xyz) {
        covariance_matrices_before6x6 = compute_covariance_matrices_tait_bryan_plane_to_plane_source_to_target(point_clouds_container,
    pose_convention);
    }
    if (rotation_matrix_parametrization == RotationMatrixParametrization::rodrigues) {
        covariance_matrices_before6x6 = compute_covariance_matrices_rodrigues_plane_to_plane_source_to_target(point_clouds_container,
    pose_convention);
    }
    if (rotation_matrix_parametrization == RotationMatrixParametrization::quaternion) {
        covariance_matrices_before7x7 = compute_covariance_matrices_quaternion_plane_to_plane_source_to_target(point_clouds_container,
    pose_convention);
    }
    */
    //----------------------------------------------------------------------------------------------------
    ...
    /*
    if (rotation_matrix_parametrization == RotationMatrixParametrization::tait_bryan_xyz) {
        covariance_matrices_after6x6 = compute_covariance_matrices_tait_bryan_plane_to_plane_source_to_target(point_clouds_container,
    pose_convention);
    }
    if (rotation_matrix_parametrization == RotationMatrixParametrization::rodrigues) {
        covariance_matrices_after6x6 = compute_covariance_matrices_rodrigues_plane_to_plane_source_to_target(point_clouds_container,
    pose_convention);
    }
    if (rotation_matrix_parametrization == RotationMatrixParametrization::quaternion) {
        covariance_matrices_after7x7 = compute_covariance_matrices_quaternion_plane_to_plane_source_to_target(point_clouds_container,
    pose_convention);
    }
    ...
    for (size_t ii = job->index_begin_inclusive; ii < job->index_end_exclusive; ii++)
    {
        ...
        for (size_t ni = 0; ni < (*all_nns).size(); ni++)
        {
            for (size_t nj = 0; nj < (*all_nns)[ni].size(); nj++)
            {
                ...
                // flip
                Eigen::Vector3d p_s_global(
                    (*point_clouds)[index_source].m_pose * (*point_clouds)[index_source].points_local[(*all_nns)[ni][nj].first]);
                Eigen::Vector3d nv_s_global(
                    (*point_clouds)[index_source].m_pose.rotation() *
                    (*point_clouds)[index_source].normal_vectors_local[(*all_nns)[ni][nj].first]);
...
bool RegistrationPlaneFeature::optimize_plane_to_plane_source_to_target(
    ...
    for (int iter = 0; iter < number_of_iterations; iter++)
    {
        ...
        for (int i = 0; i < point_clouds_container.point_clouds.size(); i++)
        {
            ...
            if (is_adaptive_robust_kernel)
            {
                ...
                std::cout << "barron_alpha_a: " << barron_alpha_a << " barron_alpha_b: " << barron_alpha_b
                          << " barron_alpha_c: " << barron_alpha_c << " barron_alpha_d: " << barron_alpha_d << std::endl;
            }
            ...
            for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
            {
                if (i != j)
                {
                    ...
                    for (size_t k = 0; k < nns.size(); k++)
                    {
                        ...
                        Eigen::Vector3d p_s_global(
                            point_clouds_container.point_clouds[i].m_pose *
                            point_clouds_container.point_clouds[i].points_local[nns[k].first]);
                        Eigen::Vector3d nv_s_global(
                            point_clouds_container.point_clouds[i].m_pose.rotation() *
                            point_clouds_container.point_clouds[i].normal_vectors_local[nns[k].first]);
                        ...
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::tait_bryan_xyz)
                        {
                            delta = get_plane_to_plane_source_to_target_tait_bryan(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::rodrigues)
                        {
                            delta = get_plane_to_plane_source_to_target_rodrigues(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::quaternion)
                        {
                            delta = get_plane_to_plane_source_to_target_quaternion(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                        }
                        ...
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::tait_bryan_xyz)
                        {
                            jacobian4x6 = get_plane_to_plane_source_to_target_tait_bryan_jacobian(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::rodrigues)
                        {
                            jacobian4x6 = get_plane_to_plane_source_to_target_rodrigues_jacobian(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                        }
                        if (rotation_matrix_parametrization == RotationMatrixParametrization::quaternion)
                        {
                            jacobian4x7 = get_plane_to_plane_source_to_target_quaternion_jacobian(
                                pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                        }
...
std::vector<Eigen::Matrix<double, 6, 6, Eigen::RowMajor>> RegistrationPlaneFeature::
    compute_covariance_matrices_tait_bryan_plane_to_plane_source_to_target(
        ...
        for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
        {
            if (i != j)
            {
                ...
                for (size_t k = 0; k < nns.size(); k++)
                {
                    ...
                    // flip
                    Eigen::Vector3d p_s_global(
                        point_clouds_container.point_clouds[i].m_pose * point_clouds_container.point_clouds[i].points_local[nns[k].first]);
                    Eigen::Vector3d nv_s_global(
                        point_clouds_container.point_clouds[i].m_pose.rotation() *
                        point_clouds_container.point_clouds[i].normal_vectors_local[nns[k].first]);
                    ...
                    Eigen::Matrix<double, 4, 1> delta = get_plane_to_plane_source_to_target_tait_bryan(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                    ...
                    Eigen::Matrix<double, 4, 6, Eigen::RowMajor> jacobian = get_plane_to_plane_source_to_target_tait_bryan_jacobian(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
...
std::vector<Eigen::Matrix<double, 6, 6, Eigen::RowMajor>> RegistrationPlaneFeature::
    compute_covariance_matrices_rodrigues_plane_to_plane_source_to_target(
        PointClouds& point_clouds_container, PoseConvention pose_convention)
{
    std::vector<Eigen::Matrix<double, 6, 6, Eigen::RowMajor>> covariance_matrices;
        ...
        for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
        {
            if (i != j)
            {
                ...
                for (size_t k = 0; k < nns.size(); k++)
                {
                    ...
                    Eigen::Matrix<double, 4, 1> delta = get_plane_to_plane_source_to_target_rodrigues(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
                    ...
                    Eigen::Matrix<double, 4, 6, Eigen::RowMajor> jacobian = get_plane_to_plane_source_to_target_rodrigues_jacobian(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
...
std::vector<Eigen::Matrix<double, 7, 7, Eigen::RowMajor>> RegistrationPlaneFeature::
    compute_covariance_matrices_quaternion_plane_to_plane_source_to_target(
        PointClouds& point_clouds_container, PoseConvention pose_convention)
{
        ...
        for (int j = 0; j < point_clouds_container.point_clouds.size(); j++)
        {
            if (i != j)
            {
                ...
                for (size_t k = 0; k < nns.size(); k++)
                {
                    ...
                    Eigen::Matrix<double, 4, 7, Eigen::RowMajor> jacobian = get_plane_to_plane_source_to_target_quaternion_jacobian(
                        pose_convention, point_clouds_container.point_clouds[i].m_pose, pl_source_local, pl_target_global);
